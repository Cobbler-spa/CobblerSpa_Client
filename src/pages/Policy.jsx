...
const Policy = () => {
  ...
  return (
    <section className="policyPage" style={back}>
      <div className="container" style={styles}>
        <p dir="ltr" style={{textAlign:"center"}}>
          <strong>TERMS OF SERVICE &amp; POLICY</strong>
        </p>
        <p>
          <span>
            <span>&nbsp;</span>
        ...
        <p dir="ltr">
          <span>
            This website is operated by FusionWorkz Services LLP. Throughout the
            website, the terms &lsquo;we&rdquo;, "us " " and "our' ' refer
            toFusionWorkz Services LLP. FusionWorkz Services LLP offers this
        ...
        <p dir="ltr">
          <span>
            Any new features, accessories , products or tools which are added to
        ...
        <p dir="ltr">
          <span style={{ textDecoration: "underline solid grey" }}>
        ...
        <p dir="ltr">
          <span>(a) transmissions over various networks; and&nbsp;</span>
        </p>
        <p dir="ltr">
          <span>
        ...
        <p dir="ltr">
          <span>
            ...
            from time to time we may remove the{" "}
          </span>
        </p>
        <p>
          <span>&nbsp;</span>
        ...
        <p dir="ltr">
          <span>
            In no case shall FusionWorkz Services LLP, our directors, officers,
        ...
        <p dir="ltr">
          <span>
            You agree to indemnify, defend and hold harmless FusionWorkz
            Services LLP and our parent, subsidiaries, affiliates, partners,
        ...
        <p dir="ltr">
          <span>
            ...
            computer&rsquo;s internet protocol (IP) address in order to provide
        ...
        <p dir="ltr">
          <span>
            ...
            privacy policies in respect to the
          </span>
        </p>
        <p>
          <span>&nbsp;</span>
        ...
        <p dir="ltr">
          <span>
            Once you leave our store&rsquo;s website or are redirected to a
            third-party website or application, you are no longer governed by
            this Privacy Policy or our website&rsquo;s Terms of Service.&nbsp;
          </span>
        </p>
        <p dir="ltr">
          <span>
        ...
        <p dir="ltr">
          <span>
            ...
            effect immediately upon their posting{" "}
          </span>
        </p>
        <p>
          <span>&nbsp;</span>
        ...
        <p dir="ltr">
          <span>
            on the website. If we make material changes to this policy, we will
        ...
        <p dir="ltr">
          <span>Late or missing refunds (if applicable)</span>
        </p>
        <p dir="ltr">
          <span>
            If you haven&rsquo;t received a refund yet, first check your bank
            account again.
          </span>
        </p>
        <p dir="ltr">
        ...
        <p dir="ltr">
          <span>
            ...
            your refund yet, please contact us at support@cobblerspa.com&nbsp;
          </span>
        </p>
        <p dir="ltr">
          <span>
        ...
        <p dir="ltr">
          <span>Sale items (if applicable)</span>
        </p>
        <p>
          <span>&nbsp;</span>
        </p>
        ...
        <p dir="ltr">
          <span>Exchanges (if applicable)</span>
        </p>
        <p dir="ltr">
          <span>
            <span>&nbsp;</span>
        ...
        <p dir="ltr">
          <span>and send your item to: K-11/3, DLF PH 2, Gurgaon 12202.</span>
        </p>
        <p dir="ltr">
          <span>
            <span>
        ...
        <p dir="ltr">
          <span>
            ...
            to you, you&rsquo;ll receive a gift credit for the value of your
        ...
        <p dir="ltr">
          <span>
            &nbsp;If you are shipping an item over ₹2000, you should consider
            using a trackable shipping service or purchasing shipping insurance.
            We don&rsquo;t guarantee that we will receive your returned item
          </span>
        </p>
        <p dir="ltr">
          <span>
        ...
        <p dir="ltr">
          <span>
            *In case of any loss or damage to any customer's article, Sneakinn
            will be liable to pay upto 5 times the service amount being charged
            (excluding GST).
          </span>
        </p>
        <p dir="ltr">
        ...
        <p dir="ltr">
          <span>Laundry Article Damages and Refunds:</span>
        </p>
        <p dir="ltr">
          <span>
            In case of any damage and/or loss of a customer's article, Sneakinn
            will be liable to pay upto 5 times the service amount being charged
            (excluding GST).
          </span>
        </p>
